            ...
            <div className='bg-primary/40 py-2'>
                <div className='container flex justify-between items-center'>
                    ...
                    px-2 py-1 focus:outline-none focus:border-1 focus:border-primary dark:border-gray-500 dark:bg-gray-800' />
                        ...
                        {/* order button */}
                        <button onClick={() => handleOrderPopup()} className='bg-gradient-to-r from-primary to-secondary transition-all duration-300 py-1 px-4 rounded-full flex items-center text-white gap-3 group'>
                            <span
